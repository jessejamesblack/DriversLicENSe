# PolicyLens Experiment Walkthrough

PolicyLens is a document intelligence experiment for synthetic driver license scans. It extracts important fields, validates them, and makes the result usable for dashboard and warehouse analytics.
...
The important design choice is that PolicyLens preserves both raw extracted JSON and normalized fields. Raw JSON gives auditability; normalized fields make dashboards and warehouse queries simple.
