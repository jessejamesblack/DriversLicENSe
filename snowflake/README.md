...
The local app uses local JSON persistence by default and can use DynamoDB in AWS mode. Snowflake is modeled as the analytics landing zone for normalized driver license extraction fields plus raw JSON.
